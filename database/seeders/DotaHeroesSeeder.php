...
class DotaHeroesSeeder extends Seeder
{
    public function run()
    {
        $game = Game::firstOrCreate(['name' => 'Dota 2']);
        ...
        $heroNames = [
            ...
            'Mirana', 'Monkey King', 'Morphling', 'Naga Siren', 'Nature’s Prophet',
            'Necrophos', 'Night Stalker', 'Nyx Assassin', 'Ogre Magi', 'Omniknight',
            'Oracle', 'Outworld Destroyer', 'Pangolier', 'Phantom Assassin',
